...
public class Doctor_ChooseSlotsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(Doctor_ChooseSlotsActivity.this, "Swipe to cancel the slots from the chosen!", Toast.LENGTH_LONG).show();
        ...
        reference_appt = FirebaseDatabase.getInstance().getReference("Doctors_Appointments");
        ...
        reference_token = FirebaseDatabase.getInstance().getReference("Tokens");
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(Doctor_ChooseSlotsActivity.this));
        ...
        start_view.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (chosen_date.equals("")) {
                    Toast.makeText(Doctor_ChooseSlotsActivity.this, "Select Date First", Toast.LENGTH_SHORT).show();
        ...
        choose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (chosen_date.equals("")) {
                    Toast.makeText(Doctor_ChooseSlotsActivity.this, "Select Date!", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (start_data.equals("") || start_data.equals("Start Time")) {
                    Toast.makeText(Doctor_ChooseSlotsActivity.this, "Choose Start Time!", Toast.LENGTH_SHORT).show();
                    return;
                }

                if (end_data.equals("") || end_data.equals("End Time")) {
                    Toast.makeText(Doctor_ChooseSlotsActivity.this, "Choose End Time!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                reference_booking.child(email).child(chosen_date).addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()) {
                            ...
                            if (flag == 1) {
                                Toast.makeText(Doctor_ChooseSlotsActivity.this, "You have already booked slot in this Time Frame", Toast.LENGTH_SHORT).show();
                                return;
                            } else {
                                ...
                                Toast.makeText(Doctor_ChooseSlotsActivity.this, "Slots Chosen!", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            int slots = (end - start) * 2;
                            String date = "";
        ...
        reference_booking.child(email).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    adapter = new Doctor_View_Slots_Adapter(Doctor_ChooseSlotsActivity.this, doctor_slots, date_slot, count);
                                            ...
                                            if (count != 0) {
                                                for (DataSnapshot datasnap : data.getChildren()) {
                                                    if (!(datasnap.getKey().equals("Count"))) {
                                                        ...
                                                        String phone_num = appts.getmobile();
