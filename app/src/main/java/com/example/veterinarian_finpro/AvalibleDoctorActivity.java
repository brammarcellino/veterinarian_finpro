...
import com.example.veterinarian_finpro.Adapter.Doctors_Adapter;
...
public class AvalibleDoctorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_avalible_doctor);
        ...
        nm.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.exists()) {
                    ...
                    if (listData.isEmpty()) {
                        Toast.makeText(AvalibleDoctorActivity.this, "No Doctor is available", Toast.LENGTH_SHORT).show();
                        progressBar.setVisibility(View.INVISIBLE);
                    }
                    adapter = new Doctors_Adapter(listData, emaildata, AvalibleDoctorActivity.this);
