...
public class Patient_Display_DoctorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_patient_display_doctor);
        ...
        reference_details.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    Patient_Session_Management session = new Patient_Session_Management(Patient_Display_DoctorActivity.this);
        ...
        book_app.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Patient_Display_DoctorActivity.this, Patient_Booking_AppointmentsMainActivity.class);
    ...
    public void current_prescription(View view) {
        Intent intent = new Intent(Patient_Display_DoctorActivity.this, Patient_side_prescription_recycler.class);
    ...
    public void open_chat(View view) {
        Intent intent = new Intent(Patient_Display_DoctorActivity.this, Patient_MessageActivity.class);
       intent.putExtra("email", encoded_email);
       startActivity(intent);
    }
}