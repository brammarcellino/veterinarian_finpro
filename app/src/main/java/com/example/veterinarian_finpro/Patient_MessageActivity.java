...
import com.example.veterinarian_finpro.Adapter.Patient_MessageAdapter;
...
public class Patient_MessageActivity extends AppCompatActivity {
    ...
    private String mobile,name,url="default";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                databaseReference = firebaseStorage.getReference().child(mobile);
                ...
                btn_send.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (!msg.equals("")) {
                            ...
                            sendMessage_Text(mobile, userid, msg, time, false);
                        } else {
                ...
                ref_doctor = FirebaseDatabase.getInstance().getReference("Doctors_Data").child(userid).child("doc_pic");
    ...
    private void sendMessage_Text(String sender, String time, String receiver, String message, boolean b) {
        ...
        DatabaseReference reference_pt = FirebaseDatabase.getInstance().getReference();
    }
        ...
        seenListener= reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for(DataSnapshot snapshot1: snapshot.getChildren()){
                    ...
                    if ((chat.getReceiver().equals(mobile) && chat.getSender().equals(userid))){
...
//                progressBar.setVisibility(View.INVISIBLE);
    ...
    private void upload_database() {
        databaseReference.listAll().addOnSuccessListener(new OnSuccessListener<ListResult>() {
            ...
            public void onSuccess(ListResult listResult) {
                ...
                StorageReference databaseReference1 = firebaseStorage.getReference().child(mobile + fileName);
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        databaseReference1.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                Date date = new Date();
                                String time = formatter.format(date);
                                sendMessage_image(mobile, userid, url[0], time, false);
                            }
                        });
                    }
                });
    ...
    private void sendMessage_image(String sender, String receiver, String s, String time, boolean b) {
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference();
        HashMap<String, Object> hashMap = new HashMap<>();
        hashMap.put("sender", sender);
        hashMap.put("receiver", receiver);
