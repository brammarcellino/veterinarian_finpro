...
import com.example.veterinarian_finpro.Adapter.Appointments_Adapter;
import com.example.veterinarian_finpro.model.Appointment_notif;
import com.example.veterinarian_finpro.model.Retrieve_Appointments;
...
public class DoctorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference nm = FirebaseDatabase.getInstance().getReference("Doctors_Chosen_Slots");
        patient = FirebaseDatabase.getInstance().getReference("Patient_Chosen_Slots");
        reference_doctor = FirebaseDatabase.getInstance().getReference("");
        reference_doctor.child(email).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (!snapshot.exists()) {
                    startActivity(new Intent(DoctorsActivity.this, Doctor_ChooseSlotsActivity.class));
                    Toast.makeText(DoctorsActivity.this, "Please Update your Profile First", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.nav_home:
                        startActivity(new Intent(DoctorsActivity.this, AskRoleActivity.class));
                        break;
                    case R.id.profile:
                        startActivity(new Intent(DoctorsActivity.this, Doctors_View_Profile.class));
                        break;
                    case R.id.slots:
                        startActivity(new Intent(DoctorsActivity.this, Doctor_ChooseSlotsActivity.class));
                        break;
                    case R.id.appointment:
                        startActivity(new Intent(DoctorsActivity.this, Appointments.class));
                        break;
                    case R.id.chats:
                        startActivity(new Intent(DoctorsActivity.this, Doctor_Chat_Display.class));
                        break;
                    ...
                    case R.id.linkedin:
                        ...
                        break;
                    case R.id.logout:
                        Doctors_Session_Mangement doctors_session_mangement = new Doctors_Session_Mangement(DoctorsActivity.this);
                        doctors_session_mangement.removeSession();
                        FirebaseAuth.getInstance().signOut();
                        Intent intent1 = new Intent(DoctorsActivity.this, AskRoleActivity.class);
            ...
            reference.child(email).addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        ...
                        adapter = new Appointments_Adapter(current_appt, DoctorsActivity.this);
