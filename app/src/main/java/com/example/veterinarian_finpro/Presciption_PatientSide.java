...
import com.example.veterinarian_finpro.model.PrescriptionDetails;
...
public class Presciption_PatientSide extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doctor = FirebaseDatabase.getInstance().getReference("Users");
        prescription_doctor = FirebaseDatabase.getInstance().getReference("Prescription_By_Doctor");
        ...
        prescription_doctor.child(email).child(phone_No).child(time).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
